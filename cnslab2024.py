...
caesar = '''def encrypt_caesar(plaintext, shift):
    encrypted = []
...
def main():
    ...
    print("3. Diffie-Hellman easiest")
    print("4. Diffie-Hellman with functions")
    print("5. Diffie-Hellman with lib")
    print("6. des")
    print("7. dss")
    print("8. hill")
    print("9. exp_10")
    print("10. md5 lib")
    print("11. md5_2 very hard")
    print("12. playfair ")

    print("13. railfence")
    print("14. rsa lib easy")
    print("15. rsa w/o lib easy")
    print("16. sha")
    print("17. vigenere")
